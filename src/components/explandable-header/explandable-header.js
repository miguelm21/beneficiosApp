...
var ExplandableHeader = /** @class */ (function () {
    function ExplandableHeader(element, renderer) {
        this.element = element;
        this.renderer = renderer;
    }
    ExplandableHeader.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ExplandableHeader.prototype.resizeHeader = function (ev) {
        var _this = this;
    ...
    ], ExplandableHeader.prototype, "scrollArea", void 0);
    __decorate([
        Input('headerHeight'),
        __metadata("design:type", Number)
    ], ExplandableHeader.prototype, "headerHeight", void 0);
    ExplandableHeader = __decorate([
        Component({
            selector: 'explandable-header',
            templateUrl: 'explandable-header.html'
        }),
        __metadata("design:paramtypes", [ElementRef, Renderer])
    ], ExplandableHeader);
    return ExplandableHeader;
}());
export { ExplandableHeader };
//# sourceMappingURL=explandable-header.js.map